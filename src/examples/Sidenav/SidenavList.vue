    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'الجداول' : 'User Profile'"
        >
          <template v-slot:icon>
            <i
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'الجداول' : 'Organization Profile'"
        >
          <template v-slot:icon>
            <i
              class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"
      ...
      <li class="nav-item">
        <sidenav-item
          to="/opportunity"
          :class="getRoute() === 'opportunity' ? 'active' : ''"
          :navText="isRTL ? 'الجداول' : 'Opportunity Listings'"
        >
          <template v-slot:icon>
            <i
              class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"
